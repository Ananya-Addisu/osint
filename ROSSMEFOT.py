...
▀███████████ ███   ███ ███    ███ ▀▀███▀▀▀██▄  ███▌ ▀███████████  
  ...
  ███    █▀   ▀█   █▀  ████████▀  ▄█████████▀  █▀    ▄████████▀    
                ...
                pystyle.Write.Print(pystyle.Center.XCenter('''    
┌─────────────────────────────────────────────────────────────────────────┐
│      _____   ____   _____ _____ __  __ ______ ______ _______ _          │
│     |  __ \ / __ \ / ____/ ____|  \/  |  ____|  ____|__   __| |         │
│     | |__) | |  | | |   | |    | \  / | |__  | |__     | |  | |__       │
│     |  ___/| |  | | |   | |    | |\/| |  __| |  __|    | |  | '_ \      │
│     | |    | |__| | |___| |____| |  | | |____| |       | |  | |_) |     │
│     |_|     \____/ \_____\_____|_|  |_|______|_|       |_|  |_.__/      │
│                                                                         │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘ By@SWALL                                                               
                                           \n'''), pystyle.Colors.white_to_red, interval = 0.0005)
 ...
 [5] Поиск по БД            [16] DDOS PRO - НЕ ИСПРАВНО                      
 [6] DDoS - НЕ ИСПРАВНО     [17] Генератор вымышленной карты    
...
я передэлал нимношко под свой :) @TerMuxOnlyFans
...
Отправили письмо - следуйте этим же шагам в правильной последовательности. Выйдите из Tor, Linux, а затем из VPN.\n''', pystyle.Colors.white_to_red, interval = 0.005)
        ...
        "Mozilla/5.0 (X11; Linux x86_64; rv:{0}.0) Gecko/{0}{1:02d} Firefox/{0}.0",
                ...
                print()
            if choice == "21":
                pystyle.Write.Print("\n[+] ДОНАТ -> MS 5599002082881808 [+] MIR 2204120118299839 [+] Юмани :4100118778845756\n", pystyle.Colors.white_to_red, interval = 0.005)
            if choice == "22":
                pystyle.Write.Print("\n[+] СОЗДАТЕЛЬ -> @TerMuxOnlyFans\n", pystyle.Colors.white_to_red, interval = 0.005)
            if choice == "23":
