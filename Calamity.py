...
menu = '''
      ...
      ██         ██   ██    ██         ██   ██    ██  ██  ██    ██       ██          ██    
       ██████    ██   ██    ███████    ██   ██    ██      ██    ██       ██          ██    
                                        ...
                                        Channel - @ReaperSoft   
▞▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▚
    [1]: DOS                            │  [6]: FAKE CARD GENERATOR                │ [11]: XSS SCANER                         
...
Write.Print(Center.XCenter(menu), Colors.red_to_purple, interval=0.001)

while True:
    choice = Write.Input('\nSelect function number > ', Colors.red_to_white, interval=0.005)
    ...
    if choice == '6':
        ...
        domain = Write.Input("Enter domain: ", Colors.red_to_purple, interval=0.005)
        get_website_info(domain)

    elif choice == '10':
        ip_address = Write.Input("Enter IP address: ", Colors.red_to_purple, interval=0.005)
        result = ip_lookup(ip_address)
        Write.Print(result, Colors.red_to_purple, interval=0.005)

    elif choice == '11':
        url = input(Colorate.Horizontal(Colors.red_to_purple, ("Enter URL --->")))
        # XSSScan(url)  # Function is not implemented in the provided code

    elif choice == '12':
        wordlist_path = Write.Input("Enter path to wordlist: ", Colors.red_to_purple, interval=0.005)
        domain = Write.Input("Enter domain: ", Colors.red_to_purple, interval=0.005)
        ...
        phone_number = Write.Input("Enter phone number: ", Colors.red_to_purple, interval=0.005)
        info = get_phone_number_info(phone_number)
        Write.Print(info, Colors.red_to_purple, interval=0.005)
