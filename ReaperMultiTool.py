...
def search_phone_number(user_number):
    ...
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Страна: {country.get('name', 'Не найдено')}, {country.get('fullname', 'Не найдено')}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Город: {other.get('name', 'Не найдено')}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Почтовый индекс: {other.get('post', 'Не найдено')}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Код валюты: {country.get('iso', 'Не найдено')}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Телефонные коды: {data.get('capital', {}).get('telcod', 'Не найдено')}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Посмотреть в wiki: {other.get('wiki', 'Не найдено')}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Гос. номер региона авто: {region.get('autocod', 'Не найдено')}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Оператор: {other.get('oper', 'Не найдено')}, {other.get('oper_brand', 'Не найдено')}, {other.get('def', 'Не найдено')}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Местоположение: {country.get('name', 'Не найдено')}, {region.get('name', 'Не найдено')}, {other.get('name', 'Не найдено')} ({region.get('okrug', 'Не найдено')})"))
    ...
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Открыть на карте (google): https://www.google.com/maps/place/{latitude}+{longitude}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Локация: {location}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Язык общения: {lang}, {lang_code}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Столица: {capital}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Широта/Долгота: {latitude}, {longitude}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Оценка номера в сети: https://phoneradar.ru/phone/{user_number}"))

def generation_muv():
    print(Colorate.Vertical(Colors.purple_to_red, (f"[+] Все ключи будут сохранены в файл mullvad_keys.txt")))
    keys = int(input(Colorate.Vertical(Colors.purple_to_red, ("[+] Сколько нужно сгенерировать ключей:  "))))
...
def reporter_tg():
    text = input(Colorate.Vertical(Colors.purple_to_red,"[+] Введите текст жалобы: "))
    num_complaints = input(Colorate.Vertical(Colors.purple_to_red,"\n[+] Введите количество жалоб для отправки: "))
...
def check_email_info(email):
    ...
    if response.status_code == 200:
        ...
        if isinstance(info, dict):
            ...
            print(Colorate.Vertical(Colors.purple_to_red, f"Репутация: {reputation}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Подозрительно: {'Да' if info.get('suspicious') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Ссылки: {info.get('references')}"))
            
            details = info.get('details', {})
            print(Colorate.Vertical(Colors.purple_to_red, f"Черный список: {'Да' if details.get('blacklisted') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Злонамеренная активность: {'Да' if details.get('malicious_activity') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Недавняя злонамеренная активность: {'Да' if details.get('malicious_activity_recent') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Утечка учетных данных: {'Да' if details.get('credentials_leaked') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Недавняя утечка учетных данных: {'Да' if details.get('credentials_leaked_recent') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Утечка данных: {'Да' if details.get('data_breach') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Впервые увиден: {details.get('first_seen') if details.get('first_seen') else 'некогда'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Последний раз увиден: {details.get('last_seen') if details.get('last_seen') else 'некогда'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Существует домен: {'Да' if details.get('domain_exists') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Репутация домена: {details.get('domain_reputation')}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Новый домен: {'Да' if details.get('new_domain') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Дней с момента создания домена: {details.get('days_since_domain_creation') if details.get('days_since_domain_creation') else 'нету'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Подозрительное доменное расширение: {'Да' if details.get('suspicious_tld') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Спам: {'Да' if details.get('spam') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Бесплатный провайдер: {'Да' if details.get('free_provider') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Одноразовый адрес: {'Да' if details.get('disposable') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Доставимо: {'Да' if details.get('deliverable') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Принимает все: {'Да' if details.get('accept_all') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Действительный MX: {'Да' if details.get('valid_mx') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Основной MX: {details.get('primary_mx')}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Можно подделать: {'Да' if details.get('spoofable') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red, f"Строгая SPF: {'Да' if details.get('spf_strict') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red,f"DMARC наложен: {'Да' if details.get('dmarc_enforced') else 'Нет'}"))
            print(Colorate.Vertical(Colors.purple_to_red,f"Профили: {', '.join(details.get('profiles', [])) if details.get('profiles') else 'нету'}"))
        else:
            print(Colorate.Vertical(Colors.purple_to_red, info))
...
def gb():
    def print_user_data(user_id, first_name, username=None, phone_number=None):
        print(Colorate.Vertical(Colors.purple_to_red, f"    ID: {user_id:<31}"))
        print(Colorate.Vertical(Colors.purple_to_red, f"    Имя: {first_name:<29}"))
        
        if username:
            print(Colorate.Vertical(Colors.purple_to_red, f"    Username: @{username:<24}"))
        if phone_number:
            print(Colorate.Vertical(Colors.purple_to_red, f"    Номер телефона: +{phone_number:<14}"))
    ...
    token = input(Colorate.Vertical(Colors.purple_to_red, f"Введите токен вашего бота >> "))
    admin_id = input(Colorate.Vertical(Colors.purple_to_red, f"Введите ваш телеграм айди >> "))

    if not is_valid_token(token):
        print(Colorate.Vertical(Colors.purple_to_red, "{reset}     Неверный токен! Пожалуйста, повторите запуск скрипта"))
        ...
        if username:
            print(Colorate.Vertical(Colors.purple_to_red, f"Бот запущен! - для выхода [ctrl + c]\nЮзернейм вашего бота: @{username}\nОтправьте с вашего аккаунта\nКоманду - /start боту."))
        else:
            print(Colorate.Vertical(Colors.purple_to_red, "Бот запущен! - для выхода [ctrl + c]"))
        bot = telebot.TeleBot(token)
    ...
    ''', parse_mode="Markdown")
        ...
        try:
            ...
            print(Colorate.Vertical(Colors.purple_to_red, f"Произошла ошибка: {e}"))

def nakrut():
    def print_user_data(user_id, first_name, username=None, phone_number=None):
        border = "{:-^40}".format("")
        print(Colorate.Vertical(Colors.purple_to_red, border))
        print(Colorate.Vertical(Colors.purple_to_red, f"    ID: {user_id:<31}"))
        print(Colorate.Vertical(Colors.purple_to_red, f"    Имя: {first_name:<29}"))
        if username:
            print(Colorate.Vertical(Colors.purple_to_red, f"    Username: @{username:<24}"))
    ...
    token = input(Colorate.Vertical(Colors.purple_to_red, "Введите токен вашего бота >> "))
    admin_id = input(Colorate.Vertical(Colors.purple_to_red, "Введите ваш телеграм айди >> "))

    if not is_valid_token(token):
        print(Colorate.Vertical(Colors.purple_to_red, "Неверный токен! Пожалуйста, повторите запуск скрипта"))
        sys.exit()
    else:
        def get_bot_username(token):
            url = f"https://api.telegram.org/bot{token}/getMe"
...
def list_data_files():
    ...
    if data_files:
        print(Colorate.Vertical(Colors.purple_to_red, "[+] Список файлов данных в текущей директории:"))
        for data_file in data_files:
            print(Colorate.Vertical(Colors.purple_to_red, data_file))
    else:
        print(Colorate.Vertical(Colors.purple_to_red, "[-] В текущей директории нет файлов данных с расширениями .csv, .xlsx или .db."))


def spam_bot():
    API_TOKEN = input(Colorate.Vertical(Colors.purple_to_red, '[+] Введите токен бота: '))
    logging.basicConfig(level=logging.INFO)
    bot = telebot.TeleBot(API_TOKEN)
    try:
        chat_id = int(input(Colorate.Vertical(Colors.purple_to_red, "[+] Введите ID чата для спама: ")))
        spam_text = input(Colorate.Vertical(Colors.purple_to_red, "[+] Введите сообщение для спама: "))
        if chat_id and spam_text:
            for _ in range(20):
                bot.send_message(chat_id, spam_text)
                logging.info(f"Сообщение отправлено в чат {chat_id}")
                time.sleep(0.5)
            logging.info(Colorate.Vertical(Colors.purple_to_red, "[+] Спам закончен."))
    except ValueError:
        print(Colorate.Vertical(Colors.purple_to_red, "[+] Пожалуйста, введите допустимые значения."))
    except Exception as e:
        logging.error(Colorate.Vertical(Colors.purple_to_red, f"[+] Ошибка отправки сообщения в чат {chat_id}: {e}"))
    finally:
        exit()
import webbrowser
...
def logger_discord():
    ...
    response = input(Colorate.Vertical(Colors.purple_to_red, "[+] Хотите открыть Discord Image Logger? (Да/Нет): ").lower())
    if response == 'да':
        webbrowser.open_new_tab(url1)
        webbrowser.open_new_tab(url2)
    elif response == 'нет':
        print(Colorate.Vertical(Colors.purple_to_red, "[+] Выход..."))
    else:
        print("[+] Неверный ответ. Пожалуйста, введите 'Да' или 'Нет'.")
def spam_webhook():
    msg = input(Colorate.Vertical(Colors.purple_to_red, "[+] Введите текст для отправки: "))
    webhook = input(Colorate.Vertical(Colors.purple_to_red, "[+] Введите URL вебхука: "))
    while True:
        for i in range(30):
            try:   
                data = requests.post(webhook, json={'content': msg})
                if data.status_code == 204:           
                    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Отправлено сообщение: {msg}"))
            except:
                print(Colorate.Vertical(Colors.purple_to_red, "[+] Ошибка вебхука: " + webhook))

def generate_and_save_mac_addresses(filename):
    num_addresses = int(input(Colorate.Vertical(Colors.purple_to_red, "[+] Введите количество MAC адресов для генерации: ")))
    ...
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] {num_addresses} MAC адресов были сохранены в файл '{filename}'."))

def generate_emails_and_save_to_file():
    fake = Faker()
    num_emails = int(input(Colorate.Vertical(Colors.purple_to_red, "[+] Сколько адресов электронной почты сгенерировать?: ")))
    ...
    print()
    for email in emails:
        print(Colorate.Vertical(Colors.purple_to_red, email))
...
def get_network_info():
    ...
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Имя хоста: {hostname}"))
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Локальный IP-адрес: {local_ip}"))
    ...
    for interface, addrs in net_if_addrs.items():
        ...
        if interface in net_if_stats:
            ...
            print(Colorate.Vertical(Colors.purple_to_red, f"[+] Статус: {'Включен' if is_up else 'Выключен'}"))
        
        for addr in addrs:
            if addr.family == socket.AF_INET:
                print(Colorate.Vertical(Colors.purple_to_red, f"  [+] IPv4 адрес: {addr.address}"))
                print(Colorate.Vertical(Colors.purple_to_red, f"  [+] Маска подсети: {addr.netmask}"))
                print(Colorate.Vertical(Colors.purple_to_red, f"  [+] Шлюз: {addr.broadcast}"))
            elif addr.family == socket.AF_INET6:
                print(Colorate.Vertical(Colors.purple_to_red, f"  [+] IPv6 адрес: {addr.address}"))
                print(Colorate.Vertical(Colors.purple_to_red, f"  [+] Маска подсети: {addr.netmask}"))
                print(Colorate.Vertical(Colors.purple_to_red, f"  [+] Шлюз: {addr.broadcast}"))
            elif addr.family == psutil.AF_LINK:
                print(Colorate.Vertical(Colors.purple_to_red, f"  [+] MAC адрес: {addr.address}"))
...
def translate_text():
    ...
    text_to_translate = input(Colorate.Vertical(Colors.purple_to_red, "\n[?] Введите текст для перевода с русского языка: "))
...
def generate_hash():
    data = input(Colorate.Vertical(Colors.purple_to_red, "[?] Введите данные для хеширования: "))
    hash_object = hashlib.sha256()
    hash_object.update(data.encode())
    hashed_data = hash_object.hexdigest()
    print(Colorate.Vertical(Colors.purple_to_red, "[+] Хеш данных:", hashed_data))
...
def encrypt_decrypt_file():
    ...
    mode = input(Colorate.Vertical(Colors.purple_to_red, "[?] Выберите режим: \n1. Шифрование \n2. Расшифрование\n"))
    
    if mode == "1":
        input_file = input(Colorate.Vertical(Colors.purple_to_red, "[?] Введите имя входного файла: "))
        output_file_encrypted = input(Colorate.Vertical(Colors.purple_to_red, "[?] Введите имя выходного зашифрованного файла: "))
        ...
        print(Colorate.Vertical(Colors.purple_to_red, "[+] Файл успешно зашифрован."))
    
    elif mode == "2":
        input_file = input(Colorate.Vertical(Colors.purple_to_red, "[?] Введите имя входного зашифрованного файла: "))
        output_file_decrypted = input(Colorate.Vertical(Colors.purple_to_red, "[?] Введите имя выходного расшифрованного файла: "))
        ...
        print(Colorate.Vertical(Colors.purple_to_red, "[+] Файл успешно расшифрован."))

def encrypt_decrypt_base64():
    xyi = int(input(Colorate.Vertical(Colors.purple_to_red, "[?] Выберите действие (1 - шифрование, 2 - расшифрование): ")))
    ...
    if xyi == 1:
        ...
        print(Colorate.Vertical(Colors.purple_to_red, "[+] Зашифрованный текст:", encrypted_text))
    elif xyi == 2:
        ...
        print(Colorate.Vertical(Colors.purple_to_red, "[+] Расшифрованный текст:", decrypted_text))
    else:
        print(Colorate.Vertical(Colors.purple_to_red, "[-] Неправильный выбор. Введите 1 для шифрования и 2 для расшифрования."))
...
def monitor_network_traffic(interval=1):
    ...
    print(Colorate.Vertical(Colors.purple_to_red, "[+] Начало мониторинга сетевого трафика (нажмите Ctrl+C для выхода)"))
    try:
        while True:
            time.sleep(interval)
            ...
            print(Colorate.Vertical(Colors.purple_to_red, f"[+] Отправлено: {sent}, Получено: {recv}\n"))
            old_value = new_value
    except KeyboardInterrupt:
        print(Colorate.Vertical(Colors.purple_to_red, "[+] Мониторинг остановлен"))

def get_my_ip():
    try:
        response = requests.get('https://httpbin.org/ip')
        ip_info = response.json()
        print(Colorate.Vertical(Colors.purple_to_red, f"[+] Ваш IP: {ip_info['origin']}"))
    except Exception as e:
        print(Colorate.Vertical(Colors.purple_to_red, f"[-] Произошла ошибка: {e}"))

def port_scan_v2():
    init()
    target = input(Colorate.Vertical(Colors.purple_to_red, "[?] Введите IP-адрес: "))
    ...
    print(Colorate.Vertical(Colors.purple_to_red, f"[+] Открытых портов: {len(open_ports)}"))

    with open('open_ports.txt', 'w') as file:
        for port in open_ports:
            file.write(str(port) + '\n')

    print(Colorate.Vertical(Colors.purple_to_red, "[+] Информация о открытых портах сохранена в файл open_ports.txt"))
...
while True:
            clear_console()
            print(Center.XCenter(Colorate.Horizontal(Colors.purple_to_red, banner)))
            print(Center.XCenter(Colorate.Horizontal(Colors.purple_to_red, menu)))
            choice = input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Введите номер опции:  "))
            clear_console()
            print(Center.XCenter(Colorate.Horizontal(Colors.purple_to_red, banner)))
            if choice == "1":
                ...
                user_number = input(Colorate.Vertical(Colors.purple_to_red, "[+] Введите номер телефона (например, +79833170773): ").strip())
                print()
                search_phone_number(user_number)
                input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == "2":
                domain = pystyle.Write.Input("\n[?] Введите сайт -> ", pystyle.Colors.purple_to_red, interval = 0.005)
...
[+] IP-адрес: {domain_info.name_servers}
        """
                    pystyle.Write.Print(print_string, pystyle.Colors.purple_to_red, interval=0.005)
            ...
            if choice == "3":
                ...
                ip_address = input(Colorate.Vertical(Colors.purple_to_red, "Введите IP-адрес: "))
                whois_info = get_whois_info(ip_address)
                print()
                print(Colorate.Vertical(Colors.purple_to_red, whois_info))
                input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == "4":
                path = pystyle.Write.Input("\n[?] Введите путь к БД: ", pystyle.Colors.purple_to_red, interval=0.005)
                search_text = pystyle.Write.Input("\n[?] Введите текст:  ", pystyle.Colors.purple_to_red, interval=0.005)
                print()
                try:
                    with open(path, "r", encoding="utf-8") as f:
                        for line in f:
                            if search_text in line:
                                pystyle.Write.Print("[+] Результат: " + line.strip(), pystyle.Colors.purple_to_red, interval=0.005)
                                print()
                                break
                        else:
                    ...
                    try:
                        ...
                        try:
                            ...
                            input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == "5":
                url = pystyle.Write.Input("[?] URL: ", pystyle.Colors.purple_to_red, interval=0.005)
                num_requests = int(
                    pystyle.Write.Input(
                        "[?] Введите количество запросов: ", pystyle.Colors.purple_to_red, interval=0.005
                    )
                )
                user_agents = [
                ...
                def send_request(i):
                    ...
                    try:
                        response = requests.get(url, headers=headers)
                        print(Colorate.Vertical(Colors.purple_to_red, f"{colorama.Fore.purple_to_red}[+] Request {i} sent successfully\n"))
                    except:
                        print(Colorate.Vertical(Colors.purple_to_red, f"[+] Request {i} sent successfully\n"))
                threads = []
            ...
            if choice == "6":
                def get_proxy():
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            pystyle.Write.Print(f"\nПроизошла ошибка -> {response.status_code}", pystyle.Colors.purple_to_red, interval=0.005)
                    except Exception as e:
                        pystyle.Write.Print(f"\nПроизошла ошибка -> {str(e)}", pystyle.Colors.purple_to_red, interval=0.005)
                ...
                if proxies:
                    ...
                    for proxy in proxies:
                        pystyle.Write.Print("\n" + proxy, pystyle.Colors.purple_to_red, interval=0.005)
                    print()
                else:
                    pystyle.Write.Print("Прокси недоступно.", pystyle.Colors.purple_to_red, interval=0.005)
                    input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == "7":
            ...
            if choice == "8":
                ...
                def generate_password(length, complexity):
                    ...
                    return password
                password_length = int(
                    pystyle.Write.Input("[?] Введите длину пароля -> ", pystyle.Colors.purple_to_red, interval=0.005)
                )
                complexity = pystyle.Write.Input(
                    "[?] Выберите сложность (low, medium, high): ", pystyle.Colors.purple_to_red, interval=0.005)
                print()
                complex_password = generate_password(password_length, complexity)
                pystyle.Write.Print("[+] Пароль -> "+ complex_password + "\n", pystyle.Colors.purple_to_red, interval=0.005)
                input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == '13':
                pystyle.Write.Print("\n[?] Выберите режим: ", pystyle.Colors.purple_to_red, interval=0.005)
                pystyle.Write.Print("\n\n[?] 1 - проверить часто используемые порты", pystyle.Colors.purple_to_red, interval=0.005)
                pystyle.Write.Print("\n\n[?] 2 - проверить указанный порт", pystyle.Colors.purple_to_red, interval=0.005)
                mode = pystyle.Write.Input("\n\n[?] Ваш выбор: ", pystyle.Colors.purple_to_red, interval=0.005)
                if mode == "1":
                    print()
                    ports = [
                        20,
                    ...
                    for port in ports:
                        ...
                        if result == 0:
                            pystyle.Write.Print(f"[+] Порт {port} открыт", pystyle.Colors.purple_to_red, interval=0.005)
                        else:
                            pystyle.Write.Print(f"[+] Порт {port} закрыт", pystyle.Colors.purple_to_red, interval=0.005)
                        sock.close()
                        print()
                    input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
                elif mode == "2":
                    port = pystyle.Write.Input("\n[?] Введите номер порта: ", pystyle.Colors.purple_to_red, interval=0.005)
                    sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
                    ...
                    pystyle.Write.Print("\n[!] Неизвестный режим", pystyle.Colors.purple_to_red, interval=0.005)
                    print()
                    input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == "9":
                fake = faker.Faker(locale="ru_RU")
                gender = pystyle.Write.Input("\n[?] Введите пол (М - мужской, Ж - женский): ", pystyle.Colors.purple_to_red, interval=0.005)
                print()
                ...
                input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == "10":
                start_url = pystyle.Write.Input("[?] Введите ссылку -> ", pystyle.Colors.purple_to_red, interval=0.005)
                max_depth = 2
                visited = set()
            ...
            if choice == "11":
                ...
                pystyle.Write.Print("\n[+] Страна: " + card["Страна"], pystyle.Colors.purple_to_red, interval=0.005)
                pystyle.Write.Print("\n[+] Номер карты: " + card["Номер карты"], pystyle.Colors.purple_to_red, interval=0.005)
                pystyle.Write.Print("\n[+] Срок действия: " + card["Срок действия"], pystyle.Colors.purple_to_red, interval=0.005)
                pystyle.Write.Print("\n[+] CVV: " + card["CVV"] + "\n", pystyle.Colors.purple_to_red, interval=0.005)
                input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == "12":
                ...
                mac_address = pystyle.Write.Input("[?] Введите Mac-Address -> ", pystyle.Colors.purple_to_red, interval = 0.005)
            ...
            if choice == "14":
                num_agents = pystyle.Write.Input("\n[?] Введите кол-во User-agent -> ", pystyle.Colors.purple_to_red, interval = 0.005)
        ...
        "Mozilla/5.0 (X11; Linux x86_64; rv:{0}.0) Gecko/{0}{1:02d} Firefox/{0}.0",
                    ...
                    for _ in range(num_agents):
                        ...
                        pystyle.Write.Print("\n" + user_agent, pystyle.Colors.purple_to_red, interval = 0.005)
            ...
            if choice == '18':
                ...
                for proxy in proxies:
                    print(Colorate.Vertical(Colors.purple_to_red, proxy))
                input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))

            if choice == '16':
                  num_keys = int(input(Colorate.Vertical(Colors.purple_to_red, "[+] Введите количество ключей для генерации: ")))
                  token_length = 72
                  keys = [generate_discord_key(token_length) for _ in range(num_keys)]
                  filename = "token_discord.txt"
                  save_keys_to_file(keys, filename)
                  print(Colorate.Vertical(Colors.purple_to_red, f"[+] {num_keys} ключей было сгенерировано и сохранено в файл {filename}."))
                  input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == '17':
                try:
                    num_phones = int(input(Colorate.Vertical(Colors.purple_to_red,"[+] Введите количество номеров для генерации: ")))
                    if num_phones <= 0:
                        print(Colorate.Vertical(Colors.purple_to_red,"[+] Количество номеров должно быть положительным числом."))
                        sys.exit()
                    ...
                    print(Colorate.Vertical(Colors.purple_to_red,f"[+] {num_phones} номеров сохранены в файл {filename}"))
                    input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
                except ValueError:
                    print(Colorate.Vertical(Colors.purple_to_red,"[-] Пожалуйста, введите корректное целое число."))
                    input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == '19':
              reporter_tg()
              input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == '20':
              ...
              input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == '21':
              print(Colorate.Vertical(Colors.purple_to_red, "[!] У этой опции есть лимиты используйте ее с умом. Либо используйте VPN и меняйте свое IP\n\n"))
              email = input(Colorate.Vertical(Colors.purple_to_red, "[+] Введите адрес электронной почты: "))
            ...
            if choice == '30':
              ...
              input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == '99':
              print(Colorate.Vertical(Colors.purple_to_red, "https://t.me/ReaperSoft"))
              input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == '98':
              print(Colorate.Vertical(Colors.purple_to_red, "ReaperSoft<3"))
              input(Colorate.Vertical(Colors.purple_to_red, "\n[+] Нажмите Enter, чтобы вернуться в главное меню."))
            if choice == '31':
